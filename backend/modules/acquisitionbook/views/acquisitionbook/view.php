...
<div class="acquisition-books-view">
    ...
    <p>
        ...
        <?= Html::a('Borrar', ['delete', 'acquisition_books_id' => $model->acquisition_books_id, 'acquisition_format_id' => $model->acquisition_format_id], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => 'Estas seguro de querer borrar esta adquisición?',
                'method' => 'post',
            ],
        ]) ?>
    </p>
